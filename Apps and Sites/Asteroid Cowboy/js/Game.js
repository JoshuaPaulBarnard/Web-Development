...
SpaceHipster.Game.prototype = {
  ...
  generateCollectables: function() {
    ...
    for (var i = 0; i < numCollectables; i++) {
      ...
      collectable.scale.setTo(this.game.rnd.integerInRange(5,30)/10)
  ...
  generateAsteriods: function() {
    ...
    //phaser's random number generator
    var numAsteroids = this.game.rnd.integerInRange(125, 175)
    var asteriod;
    ...
    for (var i = 0; i < numAsteroids; i++) {
      ...
      //physics properties
      asteriod.body.velocity.x = this.game.rnd.integerInRange(-15, 15);
      asteriod.body.velocity.y = this.game.rnd.integerInRange(-15, 15);
  ...
  collect: function(player, collectable) {
    ...
    //update score
    if(collectable.scale.x < 1)
    {
      this.playerScore = this.playerScore + 3;
    }
    else if(collectable.scale.x < 2)
    {
